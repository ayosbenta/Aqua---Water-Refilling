...
const CreateBookingPage: React.FC<CreateBookingPageProps> = ({ addBooking, navigateTo, gallonTypes, timeSlots, gallonPrice }) => {
    ...
    const totalAmount = gallonCount * gallonPrice;
        ...
        <div className="bg-secondary min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="gallonCount" className="block text-sm font-medium text-gray-700">Number of Gallons</label>
